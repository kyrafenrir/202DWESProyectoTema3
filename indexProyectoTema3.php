...
<html lang="es">
    ...
    <body>
        <header>
            <h1>TEMA 3: CARACTERÍSTICAS DEL LENGUAJE PHP</h1>
        </header>
        <table>
            <tr>
                <th>Nº</th>
                <th>Ejercicios del tema 3</th>
                <th>Ejecutar</th>
                <th>Código</th>
            </tr>
            <tr>
                <td>0</td>
                <td>HolaMundo y PhpInfo.</td>
            ...
            <tr>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio08.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>9</td>
            ...
            <tr>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio12.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>13</td>
            ...
            <tr>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio15.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>16</td>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio16.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>17</td>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio17.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>18</td>
                <td>Recorrer el array anterior utilizando funciones para obtener el mismo resultado.</td>
            ...
            <tr>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio21.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>22</td>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio22.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>23</td>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio23.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>24</td>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio24.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>25</td>
                <td>Construir un formulario para recoger un cuestionario realizado a una persona y mostrar en la misma página las preguntas y las respuestas recogidas; en el caso de que alguna respuesta esté vacía o errónea volverá a salir el formulario con el mensaje correspondiente, pero las respuestas que habíamos tecleado correctamente aparecerán en el formulario y no tendremos que volver a teclearlas.</td>
                <td><a href="codigoPHP/ejercicio25.php">Ejecutar</a></td>
                <td><a href="mostrarcodigo/muestraEjercicio25.php">Visualizar</a></td>
            </tr>
            <tr>
                <td>27</td>
                ...
                <td><a href="mostrarcodigo/muestraEjercicio27.php">Visualizar</a></td>
            </tr>
        </table>
    </body>
</html>